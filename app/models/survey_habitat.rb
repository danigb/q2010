class SurveyHabitat < ActiveRecord::Base
  HABITATS = [:suburb, :center, :city, :village, :periurbano]
  CULTURE_INFRA = [:cinema, :concert, :theater, :biblio, :exhibition, :space, :museum, :internet, :social, :calle, :parques, :bares]
  ...
  EXPENSES = [:promotion, :telecom, :formation, :mobility, :material, :comida, :formacion, :indumentaria]
